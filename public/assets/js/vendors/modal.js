    ...
    (function () {
        ...
        function i(t) {
            if (!$("[data-modal-replacer='" + $(t).attr("id") + "']").length) {
                $('<div data-modal-replacer="' + $(t).attr("id") + '"></div>').insertAfter(t),
                    $(t).css({ "margin-top": 0, "margin-left": 0 }),
                    $(t).attr("aria-hidden", !1).appendTo("#root"),
                    setTimeout(() => {
                        $(t)
                            .addClass("show")
                            .css("z-index", d() + 1);
                    ...
                    $("#root")
                        .css("padding-right", parseInt($("#root").css("padding-right")) + o("html") + "px")
        ...
        function s(t) {
            if ($(t).hasClass("modal") && $(t).hasClass("show")) {
                ...
                $(t).attr("aria-hidden", !0).removeClass("show"),
                    setTimeout(() => {
                        $(t).removeAttr("style").removeClass("modal-overlap").removeClass("overflow-y-auto"),
                            $(".modal").each(function () {
                            ...
                            d() == 9999 && $("#root").removeClass("overflow-y-hidden").css("padding-right", ""),
                            $('[data-modal-replacer="' + $(t).attr("id") + '"]').replaceWith(t);
        ...
        $("#root").on("click", '[data-tw-toggle="modal"]', function () {
            ...
            $("#root").on("click", '[data-tw-dismiss="modal"]', function () {
            ...
            document.addEventListener("keydown", (t) => {
                if (t.code == "Escape") {
                    ...
                    $(a).hasClass("modal") &&
                        $(a).hasClass("show") &&
                        ($(a).data("tw-keyboard") === void 0 || $(a).data("tw-keyboard") !== "false") &&
